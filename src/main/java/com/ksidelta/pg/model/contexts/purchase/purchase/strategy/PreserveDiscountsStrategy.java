...
public class PreserveDiscountsStrategy implements PurchaseStrategy {
    @Override
    public PurchasedStage purchase(PostDiscountStage postDiscountStage) {
        return new PurchasedStage(postDiscountStage.getFinalPrice(), postDiscountStage.getAppliedDiscounts());
    }
}
